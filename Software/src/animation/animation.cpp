...
const std::vector<std::vector<std::vector<std::vector<uint16_t>>>> ANIMATIONS = { 
    ...
    {   // Animation 4: Cross shrinking
        {   // Frame 0: 
            {0xFFFF, 0x8081, 0x8081, 0x8081, 0x8081, 0x8081, 0x8081, 0xFF81}, // Top panel
            {0x81FF, 0x8101, 0x8101, 0x8101, 0x8101, 0x8101, 0x8101, 0xFFFF}, // Bottom panel
            {0x8100, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x8100}, // Center panel
        },
        {   // Frame 1: 
            {0x0000, 0x7F7E, 0x4042, 0x4042, 0x4042, 0x4042, 0x7F42, 0x0042}, // Top panel
            {0x4200, 0x42FE, 0x4202, 0x4202, 0x4202, 0x4202, 0x7EFE, 0x0000}, // Bottom panel
            {0x4200, 0xC300, 0x0000, 0x0000, 0x0000, 0x0000, 0xC300, 0x4200}, // Center panel
        },
        {   // Frame 2: 
            {0x0000, 0x0000, 0x3F3C, 0x2024, 0x2024, 0x3F24, 0x0024, 0x0024}, // Top panel
            {0x2400, 0x2400, 0x24FC, 0x2404, 0x2404, 0x3CFC, 0x0000, 0x0000}, // Bottom panel
            {0x2400, 0x2400, 0xE700, 0x0000, 0x0000, 0xE700, 0x2400, 0x2400}, // Center panel
        },
        {   // Frame 3: 
            {0x0000, 0x0000, 0x0000, 0x1F18, 0x1F18, 0x0018, 0x0018, 0x0018}, // Top panel
            {0x1800, 0x1800, 0x1800, 0x18F8, 0x18F8, 0x0000, 0x0000, 0x0000}, // Bottom panel
